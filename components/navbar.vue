            ...
            <b-navbar toggleable="lg" fixed="top" class="bg-white pl-md-5 pr-md-5" v-b-scrollspy="20">
                ...
                <b-collapse id="nav-collapse" is-nav>
                    <b-navbar-nav class="ml-auto">
                        ...
                        <b-button squared class="d-none d-lg-block ml-lg-3" to="/current-projects" @click="removeActiveClass">Projects</b-button>
                        <b-button squared class="d-none d-lg-block ml-lg-3" to="/volunteering" @click="removeActiveClass">Volunteering</b-button>
                        <b-nav-item class="d-lg-none" to="/current-projects" @click="removeActiveClass">
                            <span class="font-weight-bold text-success">Projects</span>
                        </b-nav-item>
                        <b-nav-item class="d-lg-none" to="/volunteering" @click="removeActiveClass">
                            <span class="font-weight-bold text-success">Volunteering</span>
                        </b-nav-item>
                    </b-navbar-nav>
                </b-collapse>
            </b-navbar>
